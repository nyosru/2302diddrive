    ...
    <div class="card">
        <div class="card-header d-block d-sm-flex border-0">
            <div class="me-3">
                ...
                {{--                <span class="fs-12">список всех заказов</span>--}}
            </div>
            ...
            <span style="margin: 0 auto;">
                <div class="btn-group" role="group" aria-label="Basic example">
                    ...
                    @foreach( $menuList as $a => $m )
                        @if( $menuActive != $a )
                            <button class="btn btn-light btn-outline-{{ $m['class'] }}"
                               wire:click="setMenuActive('{{$a}}')"
{{--                            >11 {{ $a }} + {{ $m['name'] }}</button>--}}
                            >{{ $m['name'] }}<sup>{{ $m['count'] }}</sup></button>
                        @else
                            <button class="btn btn-{{ $m['class'] }}">{{ $m['name'] }}<sup>{{ $m['count'] }}</sup></button>
                        @endif
                    @endforeach

                    @if(1==2)
                        <a class="btn btn-light btn-outline-info" href="#Today">Все</a>
                        <a class="btn btn-info" href="#Today">Все</a>

                        <a class="btn btn-light btn-outline-warning" href="#Today">Новые</a>
                        <a class="btn btn-warning" href="#Today">Новые</a>

                        <a class="btn btn-light btn-outline-info" href="#Today">В работе</a>
                        <a class="btn btn-info" href="#Today">В работе</a>

                        <a class="btn btn-light btn-outline-success" href="#Today">Заверённые</a>
                        <a class="btn btn-success" href="#Today">Заверённые</a>

                        <a class="btn btn-light btn-outline-secondary" href="#Today">Отменённые</a>
                        <a class="btn btn-secondary" href="#Today">Отменённые</a>
                    @endif
                </div>
            </span>
            ...
            <div class="tab-pane active show fade" id="monthly" role="tabpanel">
                <div class="table-responsive">
                    ...
                    <table class="table table-responsive-md card-table transactions-table">
                        ...
                        @foreach ($orders as $o)
                            @include('livewire.avtoas.orders-show-item',['i' => $o])
                        @endforeach
