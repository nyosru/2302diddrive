...
{{--    <link href="/dompet/xhtml/vendor/jquery-nice-select/css/nice-select.css" rel="stylesheet">--}}
{{--    <link rel="stylesheet" href="/dompet/xhtml/vendor/nouislider/nouislider.min.css">--}}
{{--    <!-- Style css -->--}}
{{--    <link href="/dompet/xhtml/css/style.css" rel="stylesheet">--}}

{{--    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">--}}
{{--    <link href="/dompet/xhtml/icons/font-awesome-5/css/all.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">--}}
...
<body>
{{--@include('didrive.layouts.preloader')--}}
@include('didrive.layouts.header')
{{--    @include('didrive.layouts.sidebar')--}}
<div class="content-body pt-3" style="min-height: 80vh;">
    @yield('content')
</div>
...
{{--                                            class="bg-success circle me-0 ms-2"></span>--}}
{{--                                    </li>--}}
{{--                                    <li class="justify-content-end">Outcome<span--}}
{{--                                            class="bg-danger circle me-0 ms-2"></span>--}}
{{--                                    </li>--}}
{{--                                </ul>--}}
{{--                            </div>--}}
...
{{--                                            <td>--}}
{{--                                                <h6 class="fs-16 font-w600 mb-0"><a href="javascript:void(0);"--}}
{{--                                                                                    class="text-black">XYZ Store ID</a>--}}
{{--                                                </h6>--}}
{{--                                                <span class="fs-14">Cashback</span>--}}
{{--                                            </td>--}}
{{--                                            <td>--}}
...
{{--                                            <td>--}}
{{--                                                <h6 class="fs-16 font-w600 mb-0"><a href="javascript:void(0);"--}}
{{--                                                                                    class="text-black">Chef Renata</a>--}}
{{--                                                </h6>--}}
{{--                                                <span class="fs-14">Transfer</span>--}}
{{--                                            </td>--}}
{{--                                            <td>--}}
...
{{--***********************************-->--}}
{{--<!-- Required vendors -->--}}
{{--<script src="/dompet/xhtml/vendor/global/global.min.js"></script>--}}
{{--<script src="/dompet/xhtml/vendor/chart.js/Chart.bundle.min.js"></script>--}}
{{--<script src="vendor/jquery-nice-select/js/jquery.nice-select.min.js"></script>--}}

{{--<!-- Apex Chart -->--}}
{{--<script src="/dompet/xhtml/vendor/apexchart/apexchart.js"></script>--}}
{{--<script src="/dompet/xhtml/vendor/nouislider/nouislider.min.js"></script>--}}
{{--<script src="/dompet/xhtml/vendor/wnumb/wNumb.js"></script>--}}

{{--<!-- Dashboard 1 -->--}}
{{--<script src="/dompet/xhtml/js/dashboard/dashboard-1.js"></script>--}}

{{--<script src="/dompet/xhtml/js/custom.min.js"></script>--}}
{{--<script src="/dompet/xhtml/js/dlabnav-init.js"></script>--}}
